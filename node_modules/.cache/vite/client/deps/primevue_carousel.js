...
import {
  script as script3
} from "./chunk-XB2KYYZO.js";
import "./chunk-WFA5P53V.js";
import {
  Ripple
...
import { resolveComponent, createElementBlock as createElementBlock2, openBlock as openBlock2, mergeProps as mergeProps2, createCommentVNode, renderSlot, createElementVNode as createElementVNode2, createBlock, withCtx, resolveDynamicComponent, Fragment, renderList, createTextVNode, toDisplayString } from "vue";
var script$1 = {
  name: "BaseCarousel",
  "extends": script,
  props: {
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock2(), createElementBlock2("div", mergeProps2({
    "class": _ctx.cx("root"),
    role: "region"
  }, _ctx.ptmi("root")), [_ctx.$slots.header ? (openBlock2(), createElementBlock2("div", mergeProps2({
    key: 0,
    "class": _ctx.cx("header")
  }, _ctx.ptm("header")), [renderSlot(_ctx.$slots, "header")], 16)) : createCommentVNode("", true), !$options.empty ? (openBlock2(), createElementBlock2("div", mergeProps2({
    key: 1,
    "class": [_ctx.cx("contentContainer"), _ctx.containerClass]
  }, _ctx.ptm("contentContainer")), [createElementVNode2("div", mergeProps2({
    "class": [_ctx.cx("content"), _ctx.contentClass],
    "aria-live": $data.allowAutoplay ? "polite" : "off"
  }, _ctx.ptm("content")), [_ctx.showNavigators ? (openBlock2(), createBlock(_component_Button, mergeProps2({
    key: 0,
    ...
    icon: withCtx(function(slotProps) {
      return [renderSlot(_ctx.$slots, "previcon", {}, function() {
        return [(openBlock2(), createBlock(resolveDynamicComponent($options.isVertical() ? "ChevronUpIcon" : "ChevronLeftIcon"), mergeProps2({
          "class": slotProps.icon
        }, _ctx.ptm("pcPrevButton")["icon"]), null, 16, ["class"]))];
      })];
    }),
    _: 3
  }, 16, ["class", "disabled", "aria-label", "unstyled", "onClick", "pt"])) : createCommentVNode("", true), createElementVNode2("div", mergeProps2({
  ...
  }, _ctx.ptm("viewport")), [createElementVNode2("div", mergeProps2({
    ref: "itemsContainer",
  ...
  }, _ctx.ptm("itemList")), [$options.isCircular() ? (openBlock2(true), createElementBlock2(Fragment, {
    key: 0
  ...
  }), 128)) : createCommentVNode("", true), (openBlock2(true), createElementBlock2(Fragment, null, renderList(_ctx.value, function(item2, index) {
    return openBlock2(), createElementBlock2("div", mergeProps2({
      key: index,
      "class": _ctx.cx("item", {
        index
  ...
  }), 128)), $options.isCircular() ? (openBlock2(true), createElementBlock2(Fragment, {
    key: 1
  ...
  }), 128)) : createCommentVNode("", true)], 16)], 16), _ctx.showNavigators ? (openBlock2(), createBlock(_component_Button, mergeProps2({
    key: 1,
    ...
    icon: withCtx(function(slotProps) {
      return [renderSlot(_ctx.$slots, "nexticon", {}, function() {
        return [(openBlock2(), createBlock(resolveDynamicComponent($options.isVertical() ? "ChevronDownIcon" : "ChevronRightIcon"), mergeProps2({
          "class": slotProps["class"]
        }, _ctx.ptm("pcNextButton")["icon"]), null, 16, ["class"]))];
      })];
    }),
    _: 3
  }, 16, ["class", "disabled", "aria-label", "unstyled", "onClick", "pt"])) : createCommentVNode("", true)], 16, _hoisted_1), $options.totalIndicators >= 0 && _ctx.showIndicators ? (openBlock2(), createElementBlock2("ul", mergeProps2({
    key: 0,
  ...
  }, _ctx.ptm("indicatorList")), [(openBlock2(true), createElementBlock2(Fragment, null, renderList($options.totalIndicators, function(indicator2, i) {
    return openBlock2(), createElementBlock2("li", mergeProps2({
    ...
    }), [createElementVNode2("button", mergeProps2({
  ...
  }), _ctx.$slots.footer ? (openBlock2(), createElementBlock2("div", mergeProps2({
    key: 3,
