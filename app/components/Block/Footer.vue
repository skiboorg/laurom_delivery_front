...
<template>
  <footer>
    <div class="container">
      <div class=" py-8 grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-36  ">
        <div class="bg-primary p-3 flex flex-col items-start justify-between rounded-md h-[300px]">
          ...
          <div class="w-full flex items-center justify-between">
            <a class="text-sm opacity-50 text-white " :href="`mailto:${t('footer_mail_1')}@${t('footer_mail_2')}`">{{t('footer_mail_1')}}@{{t('footer_mail_2')}}</a>
        ...
        <div class="flex flex-col items-start justify-between">
          <div class="flex flex-col items-start">
            ...
            <a class="text-xl font-bold"  :href="`tel:${t('footer_phone')}`">{{t('footer_phone')}}</a>
            <a class="text-xl font-bold"  :href="`mailto:${t('footer_mail_1')}@${t('footer_mail_2')}`">{{t('footer_mail_1')}}@{{t('footer_mail_2')}}</a>
        ...
        <div class="flex flex-col items-start justify-between">
          ...
          <Button fluid severity="contrast" :label="t('footer_order')"/>

        </div>
      </div>
      <div class="flex items-center border-b gap-10 py-6 flex-wrap">

        <p class="opacity-60">{{t('footer_pol')}}</p>
        <p  class="opacity-60">{{t('footer_off')}}а</p>
      </div>
